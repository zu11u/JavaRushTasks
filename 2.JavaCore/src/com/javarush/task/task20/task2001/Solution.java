...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            OutputStream outputStream = new FileOutputStream("/media/Data/TEMP/20/human_save");
            InputStream inputStream = new FileInputStream("/media/Data/TEMP/20/human_save");
    ...
    public static class Human {
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            while (bufferedReader.ready()) {
                ...
                Asset a = new Asset(assetName, assetPrice);
                assets.add(a);
            }
        }
    }
